<div>
    <div class="bg-white">
        <!-- Hero Section -->
        <section class="relative bg-orange-600 text-white py-20 md:py-32">
            <div class="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <h1 class="text-4xl sm:text-5xl md:text-6xl font-bold mb-6">Our Rooms</h1>
                <p class="text-xl sm:text-2xl max-w-3xl mx-auto mb-4">Experience comfort and luxury in Karol Bagh</p>
                <p class="text-lg sm:text-xl max-w-2xl mx-auto opacity-90">Choose from our spacious, well-appointed rooms designed for your perfect stay</p>
            </div>
        </section>
        ...
        <section class="container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
            <div class="text-center mb-12">
                ...
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Choose Your Perfect Room</h2>
                <p class="text-lg text-gray-600 max-w-3xl mx-auto">
                    All rooms are centrally located with easy access to shopping areas, railway station, metro station, airport, and Parliament.
                </p>
            </div>

            <!-- Private Double Room -->
            <div class="mb-16 bg-gray-50 rounded-2xl p-6 md:p-8 shadow-lg">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div>
                        <img src="{{asset('room/private.jpg')}}" class="w-full h-80 object-cover rounded-lg shadow-md" alt="Private Double Room" />
                    </div>
                    <div>
                        <div class="flex items-center gap-3 mb-4">
                            <span class="bg-orange-500 text-white px-3 py-1 rounded-full text-xs font-semibold">Most Popular</span>
                            <h3 class="text-3xl md:text-4xl font-bold text-gray-900">Private Double</h3>
                        </div>
                        <div class="flex items-center gap-4 mb-6">
                            <div class="text-orange-500 font-bold text-3xl">₹1,300</div>
                            <span class="text-gray-600 text-lg">per night</span>
                        </div>

                        <div class="mb-6">
                            <div class="flex items-center gap-4 text-gray-700 mb-3">
                                <span class="flex items-center gap-2">
                                    <svg class="w-5 h-5 text-orange-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                                    </svg>
                                    <span class="font-semibold">2 Guests</span>
                                </span>
                                <span class="flex items-center gap-2">
                                    <svg class="w-5 h-5 text-orange-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 5a1 1 0 011-1h4a1 1 0 011 1v7a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM14 5a1 1 0 011-1h4a1 1 0 011 1v7a1 1 0 01-1 1h-4a1 1 0 01-1-1V5zM4 16a1 1 0 011-1h4a1 1 0 011 1v3a1 1 0 01-1 1H5a1 1 0 01-1-1v-3zM14 16a1 1 0 011-1h4a1 1 0 011 1v3a1 1 0 01-1 1h-4a1 1 0 01-1-1v-3z" />
                                    </svg>
                                    <span class="font-semibold">180 sq.ft</span>
                                </span>
                                <span class="flex items-center gap-2">
                                    <svg class="w-5 h-5 text-orange-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                                    </svg>
                                    <span class="font-semibold">1 Double Bed</span>
                                </span>
                            </div>
                        </div>

                        <p class="text-gray-700 leading-relaxed mb-6">
                            Perfect for couples or solo travelers. Features a comfortable double bed, modern furnishings, and all essential amenities including Free WiFi, LED TV, air conditioning, attached bathroom with hot & cold water, work desk, and daily housekeeping.
                        </p>
                        ...
                        <button wire:click="openBookingModal('Private Double')" class="inline-block bg-orange-500 hover:bg-orange-600 text-white px-8 py-3 rounded-lg font-semibold shadow-md transition">
                            Book Now
                        </button>
                    </div>
                </div>
            ...
            <div class="mb-16 bg-gray-50 rounded-2xl p-6 md:p-8 shadow-lg">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div>
                        <img src="{{asset('room/deluxe.jpg')}}" class="w-full h-80 object-cover rounded-lg shadow-md" alt="Deluxe Room" />
                    </div>
                    <div>
                        <h3 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Deluxe Room</h3>
                        <div class="flex items-center gap-4 mb-6">
                            <div class="text-orange-500 font-bold text-3xl">₹1,600</div>
                            <span class="text-gray-600 text-lg">per night</span>
                        </div>
                        ...
                        <div class="mb-6">
                            <div class="flex items-center gap-4 text-gray-700 mb-3">
                                ...
                                <span class="flex items-center gap-2">
                                    ...
                                    <span class="font-semibold">200 sq.ft</span>
                                </span>
                                <span class="flex items-center gap-2">
                                    <svg class="w-5 h-5 text-orange-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                                    </svg>
                                    <span class="font-semibold">1 Queen Bed</span>
                                </span>
                            </div>
                        </div>

                        <p class="text-gray-700 leading-relaxed mb-6">
                            Enhanced comfort with more space and premium amenities. Perfect for guests seeking extra room to relax. Features queen-sized bed, seating area, upgraded furnishings, and all standard amenities plus additional comfort features.
                        </p>
                        ...
                        <button wire:click="openBookingModal('Deluxe Room')" class="inline-block bg-orange-500 hover:bg-orange-600 text-white px-8 py-3 rounded-lg font-semibold shadow-md transition">
                            Book Now
                        </button>
                    </div>
                </div>
            ...
            <div class="mb-16 bg-gray-50 rounded-2xl p-6 md:p-8 shadow-lg">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div>
                        <img src="{{asset('room/suite.jpg')}}" class="w-full h-80 object-cover rounded-lg shadow-md" alt="Suite Room" />
                    </div>
                    <div>
                        <div class="flex items-center gap-3 mb-4">
                            <span class="bg-orange-500 text-white px-3 py-1 rounded-full text-xs font-semibold">Premium</span>
                            <h3 class="text-3xl md:text-4xl font-bold text-gray-900">Suite Room</h3>
                        </div>
                        <div class="flex items-center gap-4 mb-6">
                            <div class="text-orange-500 font-bold text-3xl">₹2,200</div>
                            <span class="text-gray-600 text-lg">per night</span>
                        </div>
                        ...
                        <div class="mb-6">
                            <div class="flex items-center gap-4 text-gray-700 mb-3">
                                <span class="flex items-center gap-2">
                                    ...
                                    <span class="font-semibold">2-3 Guests</span>
                                </span>
                                <span class="flex items-center gap-2">
                                    <svg class="w-5 h-5 text-orange-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 5a1 1 0 011-1h4a1 1 0 011 1v7a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM14 5a1 1 0 011-1h4a1 1 0 011 1v7a1 1 0 01-1 1h-4a1 1 0 01-1-1V5zM4 16a1 1 0 011-1h4a1 1 0 011 1v3a1 1 0 01-1 1H5a1 1 0 01-1-1v-3zM14 16a1 1 0 011-1h4a1 1 0 011 1v3a1 1 0 01-1 1h-4a1 1 0 01-1-1v-3z" />
                                    </svg>
                                    <span class="font-semibold">280 sq.ft</span>
                                </span>
                                <span class="flex items-center gap-2">
                                    <svg class="w-5 h-5 text-orange-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                                    </svg>
                                    <span class="font-semibold">1 King Bed</span>
                                </span>
                            </div>
                        </div>

                        <p class="text-gray-700 leading-relaxed mb-6">
                            Luxurious suite with separate living area. Ideal for extended stays or special occasions. Features king-sized bed, spacious living room, premium amenities, mini-bar, and elegant furnishings for maximum comfort.
                        </p>
                        ...
                        <button wire:click="openBookingModal('Suite Room')" class="inline-block bg-orange-500 hover:bg-orange-600 text-white px-8 py-3 rounded-lg font-semibold shadow-md transition">
                            Book Now
                        </button>
                    </div>
                </div>
            ...
            <div class="mb-16 bg-gray-50 rounded-2xl p-6 md:p-8 shadow-lg">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div>
                        <img src="{{asset('room/twin.jpg')}}" class="w-full h-80 object-cover rounded-lg shadow-md" alt="Twin Double Room" />
                    </div>
                    <div>
                        <h3 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Twin Double</h3>
                        <div class="flex items-center gap-4 mb-6">
                            <div class="text-orange-500 font-bold text-3xl">₹1,500</div>
                            <span class="text-gray-600 text-lg">per night</span>
                        </div>
                        ...
                        <div class="mb-6">
                            <div class="flex items-center gap-4 text-gray-700 mb-3">
                                <span class="flex items-center gap-2">
                                    ...
                                    <span class="font-semibold">2-4 Guests</span>
                                </span>
                                <span class="flex items-center gap-2">
                                    <svg class="w-5 h-5 text-orange-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 5a1 1 0 011-1h4a1 1 0 011 1v7a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM14 5a1 1 0 011-1h4a1 1 0 011 1v7a1 1 0 01-1 1h-4a1 1 0 01-1-1V5zM4 16a1 1 0 011-1h4a1 1 0 011 1v3a1 1 0 01-1 1H5a1 1 0 01-1-1v-3zM14 16a1 1 0 011-1h4a1 1 0 011 1v3a1 1 0 01-1 1h-4a1 1 0 01-1-1v-3z" />
                                    </svg>
                                    <span class="font-semibold">220 sq.ft</span>
                                </span>
                                <span class="flex items-center gap-2">
                                    <svg class="w-5 h-5 text-orange-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                                    </svg>
                                    <span class="font-semibold">2 Double Beds</span>
                                </span>
                            </div>
                        </div>

                        <p class="text-gray-700 leading-relaxed mb-6">
                            Ideal for friends or small families traveling together. Features two comfortable double beds with ample space and modern amenities. Perfect for business colleagues or group travelers who need separate sleeping arrangements.
                        </p>
                        ...
                        <button wire:click="openBookingModal('Twin Double')" class="inline-block bg-orange-500 hover:bg-orange-600 text-white px-8 py-3 rounded-lg font-semibold shadow-md transition">
                            Book Now
                        </button>
                    </div>
                </div>
            ...
            <div class="mb-16 bg-gray-50 rounded-2xl p-6 md:p-8 shadow-lg">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div>
                        <img src="{{asset('room/family.jpg')}}" class="w-full h-80 object-cover rounded-lg shadow-md" alt="Family Suite" />
                    </div>
                    <div>
                        <div class="flex items-center gap-3 mb-4">
                            <span class="bg-orange-500 text-white px-3 py-1 rounded-full text-xs font-semibold">Best for Families</span>
                            <h3 class="text-3xl md:text-4xl font-bold text-gray-900">Family Suite</h3>
                        </div>
                        <div class="flex items-center gap-4 mb-6">
                            <div class="text-orange-500 font-bold text-3xl">₹4,000</div>
                            <span class="text-gray-600 text-lg">per night</span>
                        </div>
                        ...
                        <div class="mb-6">
                            <div class="flex items-center gap-4 text-gray-700 mb-3">
                                <span class="flex items-center gap-2">
                                    ...
                                    <span class="font-semibold">4-6 Guests</span>
                                </span>
                                <span class="flex items-center gap-2">
                                    <svg class="w-5 h-5 text-orange-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 5a1 1 0 011-1h4a1 1 0 011 1v7a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM14 5a1 1 0 011-1h4a1 1 0 011 1v7a1 1 0 01-1 1h-4a1 1 0 01-1-1V5zM4 16a1 1 0 011-1h4a1 1 0 011 1v3a1 1 0 01-1 1H5a1 1 0 01-1-1v-3zM14 16a1 1 0 011-1h4a1 1 0 011 1v3a1 1 0 01-1 1h-4a1 1 0 01-1-1v-3z" />
                                    </svg>
                                    <span class="font-semibold">400 sq.ft</span>
                                </span>
                                <span class="flex items-center gap-2">
                                    <svg class="w-5 h-5 text-orange-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                                    </svg>
                                    <span class="font-semibold">Multiple Beds</span>
                                </span>
                            </div>
                        </div>

                        <p class="text-gray-700 leading-relaxed mb-6">
                            Spacious suite perfect for families. Multiple bedrooms, large living area, and premium amenities. Features separate living room, dining area, kitchenette, multiple bathrooms, and everything your family needs for a comfortable extended stay.
                        </p>
                        ...
                        <button wire:click="openBookingModal('Family Suite')" class="inline-block bg-orange-500 hover:bg-orange-600 text-white px-8 py-3 rounded-lg font-semibold shadow-md transition">
                            Book Now
                        </button>
                    </div>
                </div>
        ...
        <section class="bg-gradient-to-br from-gray-50 to-orange-50 py-16 md:py-20">
            <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-12">
                    <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4">All Rooms Include</h2>
                    <p class="text-lg text-gray-700">Standard amenities available in every room</p>
                </div>

                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    <div class="bg-white rounded-xl p-6 shadow-md text-center">
                        <div class="bg-orange-50 w-14 h-14 rounded-full flex items-center justify-center mb-3 mx-auto">
                        ...
                        <p class="font-semibold text-gray-900">AC</p>
                    </div>
                    ...
                    <div class="bg-white rounded-xl p-6 shadow-md text-center">
                        ...
                        <p class="font-semibold text-gray-900">Free WiFi</p>
                    </div>
                    ...
                    <div class="bg-white rounded-xl p-6 shadow-md text-center">
                        ...
                        <p class="font-semibold text-gray-900">LED TV</p>
                    </div>
                        ...
                        <div class="bg-orange-50 w-14 h-14 rounded-full flex items-center justify-center mb-3 mx-auto">
                            <svg class="w-7 h-7 text-orange-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M4 10h16M4 14h16M5 18h14a2 2 0 002-2v-1a2 2 0 00-2-2H5a2 2 0 00-2 2v1a2 2 0 002 2zm0-8a4 4 0 014-4h6a4 4 0 014 4v0" />
                            </svg>

                        </div>
                        <p class="font-semibold text-gray-900">Pure Veg Food</p>
                    </div>
                    ...
                    <div class="bg-white rounded-xl p-6 shadow-md text-center">
                        ...
                        <p class="font-semibold text-gray-900">Daily Housekeeping</p>
                    </div>
                    ...
                    <div class="bg-white rounded-xl p-6 shadow-md text-center">
                        ...
                        <p class="font-semibold text-gray-900">Hot Water</p>
                    </div>
                    ...
                    <div class="bg-white rounded-xl p-6 shadow-md text-center">
                        ...
                        <p class="font-semibold text-gray-900">Room Service</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="bg-gradient-to-r from-orange-500 to-orange-600 text-white py-16">
            <div class="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <p class="text-lg md:text-xl mb-8 opacity-95">
                    Contact us today to reserve your room at Brahman Bhawan, Karol Bagh
                </p>
                <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                    <a href="tel:+917011895100" class="inline-flex items-center gap-2 bg-white text-orange-500 px-8 py-4 rounded-lg font-semibold shadow-lg hover:bg-gray-100 transition">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                            <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                        </svg>
                        +91 70118 95100
                    </a>
                    <a href="{{route('contact')}}" class="inline-flex items-center gap-2 bg-transparent border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white hover:text-orange-500 transition">
                        Contact Us
